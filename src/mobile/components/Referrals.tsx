    ...
    <div>
      <div className="flex flex-col max-w-2xl min-h-[100dvh] gap-5 p-10 mx-auto bg-white">
        <div className="flex items-center justify-between w-full">
          ...
          <div
            className="flex items-center justify-center w-10 h-10 text-xl font-light text-black rounded-full cursor-pointer bg-black/5 hover:text-white hover:bg-red-300"
