...
export const DashboardTwo = () => {
  ...
  "
            ...
            <div>
              <div className="flex items-center justify-between mt-20 sm:mt-25">
              ...
              {!userReady ? (
                ...
                <div className="flex w-full gap-3 p-5 pt-10 overflow-x-auto sm:p-20 sm:overflow-visible scroll-smooth">
                  {entry ? (
                    meals.map((meal) => (
                      <div
                        key={meal.key}
