        ...
        <div className="flex items-center justify-center h-[87dvh] ">
          <div className="flex flex-col items-center">
            ...
            <p className="mb-10 font-light text-center text-black/80 w-82">
              Crea tu contraseña para Plan4Me
            </p>
            ...
            <div className="px-5 py-3 mb-10 text-[14px] font-light border rounded-sm border-black/30 w-82">
              <p className="mb-3">Tu contraseña debe contener:</p>
            ...
            <button
              className="px-4 py-3 mb-20 text-white bg-black rounded-full cursor-pointer w-82"
              onClick={() => {
                setStep(2);
              }}
            >
